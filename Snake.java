...
public class Snake {
  ...
  /**this function moves the snake in some direction
    * the direction is decided based on the direction variable
    * it returs false if it hits the wall or it hits itself
    * */  
